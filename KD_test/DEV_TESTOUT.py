...
if __name__ == '__main__':
    ...
    # dummy_input = torch.randn(1, 270, 276).to(device)
    ...
    #     model.zero_grad()
    #     mid,all=model(feature)
    #     loss=MseLOSS(feature.veiw(-1),all.veiw(-1))
    #     loss.backward()
    #     optimizer.step()
    ...
    for epoch in range(EPOCHS):
        ...
        print('valid Epoch: {},Loss: {:.6f}'.format(epoch,valid_epoch_loss/len(validation_loader)))
